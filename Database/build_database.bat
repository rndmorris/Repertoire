...
%MYSQL% --user=%MYSQL_USER% --password=%MYSQL_PASSWORD% --database=Repertoire < "%SCRIPT_DIRECTORY%00_create_Repertoire.sql"
...
%MYSQL% --user=%MYSQL_USER% --password=%MYSQL_PASSWORD% --database=Repertoire < "%SCRIPT_DIRECTORY%01_populate_data.sql"

ECHO Creating SQL Users
%MYSQL% --user=%MYSQL_USER% --password=%MYSQL_PASSWORD% --database=Repertoire < "%SCRIPT_DIRECTORY%02_create_users.sql"
