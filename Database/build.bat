...
%MYSQL% --user=%MYSQL_USER% --password=%MYSQL_PASSWORD% --database=Repertoire --execute=source %SCRIPT_DIRECTORY%sprocsrprtr_DictionaryDefinition_AddNew.sql;;
%MYSQL% --user=%MYSQL_USER% --password=%MYSQL_PASSWORD% --database=Repertoire --execute=source %SCRIPT_DIRECTORY%sprocsrprtr_DictionaryVersion_AddNew.sql;;
%MYSQL% --user=%MYSQL_USER% --password=%MYSQL_PASSWORD% --database=Repertoire --execute=source %SCRIPT_DIRECTORY%sprocsrprtr_AvailableDictionary_Select.sql;;
